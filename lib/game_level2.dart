...
class _GameLevel2State extends State<GameLevel2> {
  ...
  void initState() {
    ...
    _read();
    if (widget.level == 2) {
      question = "قم بترتيب الكود بحيث يصبح ما يتم طباعته منطقيًا ";
...
"اوجد جميع العمليات الحسابية للرقمين 2, 4  + >> - >> * >> / >> % >> ^ مرتبة كالتالي";
    ...
    if (widget.level == 6) {
      question = " وقيمته 12 A رتب الكود بحيث نعرف متغير وقيمته 1.2 B ثم متغير آخر  welcomeو قيمته  C وأخيرا المتغير   ";
      choices = {
